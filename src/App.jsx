  ...
  return (
    <Router>
      <Helmet>
        ...
        <meta name="description" content="Complete the interactive jigsaw puzzle and discover more about our topic and team. An engaging mobile-optimized experience." />
      </Helmet>
